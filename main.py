...
parser = argparse.ArgumentParser(description='HST')

parser.add_argument('--data', type=str, required=True, default='ECL', help='data')
parser.add_argument('--root_path', type=str, default='./data/ECL/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='ECL.csv', help='data file')
...
parser.add_argument('--period', type=str, default='24,168,672',
                    help='vested periods for global timestamps')
...
parser.add_argument('--encoder_layer', type=int, default=3, help='stage number of model')
parser.add_argument('--layer_stack', type=int, default=2, help='layer number of stage')
parser.add_argument('--patch_size', type=int, default=6,
                    help='the initial patch size in patch-wise attention')
parser.add_argument('--MODWT_level', type=int, default=3, help='the level of MODWT/MRA')
parser.add_argument('--ccc_num', type=int, default=5, help='number of correlated variables')
...
args.period = [int(per) for per in args.period.replace(' ', '').split(',')]
...
for predl in args.pred_len:
    ...
    with open(path1, "a") as f:
        ...
        f.write(',{},{},{},{},{},{}'.
                format(args.data, args.input_len, predl, args.MODWT_level
                       , mse, mae) + '\n')
        f.flush()
        f.close()
